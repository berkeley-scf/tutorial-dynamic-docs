...
To use the bash kernel in BCE or on your own machine, you will need to do some additional installation. In particular, in BCE please run the relevant commands in *bce.sh*.
