...
# 1) Some basic Markdown formatting
...
# 2) Embedding equations using LaTeX
...
# 4) Embedding bash and Python code
...
# 5) Reading code from an external file
...
# 6) Formatting of long lines of code and of output
